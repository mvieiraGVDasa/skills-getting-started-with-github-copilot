...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 18,
        "participants": ["nina@mergington.edu", "ellie@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice skills and compete in friendly basketball games",
    ...
    "Drama Club": {
        "description": "Acting, stagecraft, and play production for theater lovers",
